...
const carouselData = [
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/e/ed/Walt_disney_portrait.jpg",
  ...
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/4/4e/Steamboat-willie.jpg",
  ...
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/en/4/49/Snow_White_1937_poster.png",
    content: "Released in 1937, Snow White and the Seven Dwarfs was dubbed \"Disney's Folly\" during production. It became the first full-length cel animated feature in history, proving critics wrong. Its massive success provided the capital to build the Burbank studios and established Disney as the undisputed leader in feature animation."
  },
  {
    id: 4,
  ...
  },
  {
    ...
    content: "For nearly a century, Disney magic has been bringing families closer together. Through shared stories, unforgettable characters, and shared memories, the Disney legacy continues to create bonds that span generations, reminding us all of the child within."
  }
];
    ...
    <div className="w-full max-w-5xl mx-auto my-12 relative z-10">
      <div className="text-center mb-10">
        <motion.h2 
          ...
          className="text-4xl md:text-5xl font-serif text-[#8c6b22] font-bold mb-4 drop-shadow-sm"
        >
          Welcome to the Digital Tasting Experience
        </motion.h2>
        <motion.p 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
