...
import footerImage from '../assets/footer_image-removebg-preview.png';

const footerLinks = [
    {
        heading: 'Explore',
        links: [
            { label: 'Movies', href: '#filmreel' },
            { label: 'Parks', href: '#parks' },
            { label: 'Disney+', href: '#streaming' },
...
export const SiteFooter = () => {
    return (
        <footer className="w-full bg-[#020818] border-t border-white/10">
            {/* Top divider glow */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-14">
                    ...
                    <div className="flex flex-col items-start gap-4">
                        <motion.a
                            ...
                            whileTap={{ scale: 0.97 }}
                        >
                            <img src={footerImage} alt="Disney" className="h-16 w-auto" />
                        </motion.a>
                        <p className="text-white/40 text-sm leading-relaxed max-w-[200px]">
                            Where every story begins and magic never ends.
                        </p>
                    </div>
